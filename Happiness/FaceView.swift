...
class FaceView: UIView
{
    ...
    //--We make this public var of the type that is the protocol.  So, anyone wants to talk to us, just set themselves to this.
    ...
    override func drawRect(rect: CGRect)
    {
       let facePath = UIBezierPath(
        ...
        let _ = blahDataSource?.smilinessForFaceView(self) //send this self to sFF
